# Generated by Django 3.2.25 on 2024-09-28 22:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline_to_receive_loan', models.DateField(default=datetime.datetime(2025, 9, 28, 22, 36, 55, 500474, tzinfo=utc), help_text='The deadline to receive the loan.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_profile', models.ForeignKey(help_text='The borrower (loan profile) for the transaction.', on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='core.loanprofile')),
                ('user', models.ForeignKey(help_text='The lender for the transaction.', on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
